...
import { ApiResponseStatusInterceptor } from './common/interceptors/api-response-status.interceptor';
...
async function bootstrap() {
  ...
  app.useGlobalInterceptors(new ApiResponseStatusInterceptor());
